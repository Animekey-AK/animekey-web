#!/usr/bin/env node
// Patches SplashScreen.storyboard after expo prebuild runs.
// expo-splash-screen always regenerates the storyboard as a centered logo —
// this replaces the center constraints with edge-pinning so the image is full-bleed.
...
const storyboardPath = path.join(
  __dirname,
  "../ios/AnimeKey/SplashScreen.storyboard"
);

if (!fs.existsSync(storyboardPath)) {
  console.log("⚠️  SplashScreen.storyboard not found — skipping patch.");
  process.exit(0);
}

const FULL_BLEED_STORYBOARD = `<?xml version="1.0" encoding="UTF-8"?>
<document type="com.apple.InterfaceBuilder3.CocoaTouch.Storyboard.XIB" version="3.0" toolsVersion="24093.7" targetRuntime="iOS.CocoaTouch" propertyAccessControl="none" useAutolayout="YES" launchScreen="YES" useTraitCollections="YES" useSafeAreas="YES" colorMatched="YES" initialViewController="EXPO-VIEWCONTROLLER-1">
    ...
    <resources>
        <image name="SplashScreenLogo" width="1206" height="2622"/>
        <systemColor name="systemBackgroundColor">
            <color white="1" alpha="1" colorSpace="custom" customColorSpace="genericGamma22GrayColorSpace"/>
        </systemColor>
        <namedColor name="SplashScreenBackground">
            <color alpha="1.000" blue="0.0274509803921569" green="0.0274509803921569" red="0.0274509803921569" customColorSpace="sRGB" colorSpace="custom"/>
        </namedColor>
    </resources>
</document>`;

fs.writeFileSync(storyboardPath, FULL_BLEED_STORYBOARD, "utf8");
console.log("✅  SplashScreen.storyboard patched to full-bleed.");
